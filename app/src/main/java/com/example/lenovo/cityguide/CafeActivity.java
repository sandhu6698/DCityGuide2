...
public class CafeActivity extends AppCompatActivity
    ...
    String URL = "https://api.myjson.com/bins/u9sn2";
    ArrayList<hotelsinfo> cafe_info;
    GridView gridView;
    GridAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cafe_info= new ArrayList<hotelsinfo>();

        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, URL, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                processJSON(response);
                adapter = new GridAdapter(CafeActivity.this,cafe_info);
        ...
        CustomRequest.getInstance(CafeActivity.this).addToRequestQue(jsonObjectRequest);
    }
    ...
    public void processJSON(JSONObject response){
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                cafe_info.add(new hotelsinfo(jHotel,image_url));
                Log.v("jHOTEL",jHotel);
